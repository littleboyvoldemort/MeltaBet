...
import { n as Badge, r as useServerFn, t as createSsrRpc } from "./createSsrRpc-CkdAslde.js";
import { t as requireSupabaseAuth } from "./auth-middleware-D6DsnQQB.js";
import { t as supabase } from "./client-BsC7W_eT.js";
import { i as cn, n as Input, r as Button, t as Label } from "./label-Cq5SXjoZ.js";
...
import { ArrowDownToLine, ArrowUpFromLine, Clock, Copy, Dices, Loader2, LogOut, Shield, Spade, Ticket, Trash2, Trophy, Users, Wallet, X } from "lucide-react";
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Link, {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: ["APEX", /* @__PURE__ */ jsx("span", {
				...
				children: signedIn ? /* @__PURE__ */ jsxs(Fragment, { children: [
					/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2 rounded-md border border-border bg-secondary px-3 py-2",
						children: [/* @__PURE__ */ jsx(Wallet, { className: "size-4 text-primary" }), /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: loading ? /* @__PURE__ */ jsx(Loader2, { className: "size-3 animate-spin" }) : `$${(balance ?? 0).toFixed(2)}`
							})]
						})]
					}),
					/* @__PURE__ */ jsxs(Button, {
						size: "sm",
						onClick: onDeposit,
						children: [/* @__PURE__ */ jsx(ArrowDownToLine, { className: "size-4" }), " Deposit"]
					}),
					/* @__PURE__ */ jsxs(Button, {
						size: "sm",
						variant: "secondary",
						onClick: onWithdraw,
						children: [/* @__PURE__ */ jsx(ArrowUpFromLine, { className: "size-4" }), " Withdraw"]
					}),
					isAdmin ? /* @__PURE__ */ jsx(Button, {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							to: "/admin",
							children: [/* @__PURE__ */ jsx(Shield, { className: "size-4" }), " Admin"]
						})
					}) : null,
					/* @__PURE__ */ jsx(Button, {
						size: "sm",
...
function MatchList({ matches, loading, error, isDemo, selected, onPick }) {
	if (loading) return /* @__PURE__ */ jsx("div", {
		className: "space-y-3",
		children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-28 w-full rounded-xl" }, i))
	});
	...
	if (matches.length === 0) return /* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-3",
		children: [isDemo ? /* @__PURE__ */ jsx("p", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: [/* @__PURE__ */ jsx(Clock, { className: "size-3" }), new Date(m.start_time).toLocaleString(void 0, {
								day: "numeric",
								month: "short",
								hour: "2-digit",
								minute: "2-digit"
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "size-1.5 animate-pulse rounded-full bg-white" }), "Live"]
				}),
				game.featured ? /* @__PURE__ */ jsx(Badge, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("span", {
					className: "flex items-center gap-1",
					children: [/* @__PURE__ */ jsx(Users, { className: "size-3.5" }), game.players.toLocaleString()]
				}), /* @__PURE__ */ jsxs("span", { children: ["Min $", game.minBet] })]
			}), /* @__PURE__ */ jsx(Button, {
				size: "sm",
				onClick: () => onPlay(game),
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Dices, { className: "size-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Real dealers · HD streams · Instant crypto payouts" })]
			}),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h3", {
				...
				children: [/* @__PURE__ */ jsx(Spade, { className: "size-3.5" }), " Featured tables"]
			}), /* @__PURE__ */ jsx("div", {
				className: "grid gap-3 sm:grid-cols-2",
				children: featured.map((game) => /* @__PURE__ */ jsx(CasinoCard, {
					game,
					signedIn,
					onPlay
				}, game.id))
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				...
				children: rest.map((game) => /* @__PURE__ */ jsx(CasinoCard, {
					game,
					signedIn,
					onPlay
				}, game.id))
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: Object.entries(CATEGORY_LABELS).map(([key, label]) => /* @__PURE__ */ jsx(Badge, {
					variant: "secondary",
					className: "text-xs",
					children: label
				}, key))
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: [
						/* @__PURE__ */ jsx(Ticket, { className: "size-4 text-primary" }),
						" Bet slip",
						/* @__PURE__ */ jsx("span", {
				...
				}), selections.length > 0 ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: onClear,
					className: "flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground",
					children: [/* @__PURE__ */ jsx(Trash2, { className: "size-3" }), " Clear"]
				}) : null]
			}),
			/* @__PURE__ */ jsx("div", {
				className: "max-h-[40vh] space-y-2 overflow-y-auto px-4 py-3 lg:max-h-[50vh]",
				children: selections.length === 0 ? /* @__PURE__ */ jsx("p", {
					className: "py-6 text-center text-sm text-muted-foreground",
					children: "Tap any odds to add a selection."
				}) : selections.map((s) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Button, {
						...
						children: [placing ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : null, signedIn ? "Place bet" : "Sign in to bet"]
					}),
					signedIn && stakeNumber > balance ? /* @__PURE__ */ jsx("p", {
...
function DepositDialog({ open, onOpenChange, walletAddress, walletLoading, submitting, onSubmit }) {
	...
	return /* @__PURE__ */ jsx(Dialog, {
		open,
		onOpenChange,
		children: /* @__PURE__ */ jsxs(DialogContent, { children: [/* @__PURE__ */ jsxs(DialogHeader, { children: [/* @__PURE__ */ jsx(DialogTitle, { children: "Deposit with USDT (BEP20)" }), /* @__PURE__ */ jsx(DialogDescription, { children: "Send USDT on the BEP20 network to the address below, then submit your transaction ID." })] }), /* @__PURE__ */ jsxs("div", {
			className: "space-y-4",
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "space-y-2",
					children: [/* @__PURE__ */ jsx(Label, { children: "Deposit address" }), /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs(Button, {
					...
					children: [submitting ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : null, " I have paid"]
				}),
				/* @__PURE__ */ jsx("p", {
...
function WithdrawDialog({ open, onOpenChange, balance, submitting, onSubmit }) {
	...
	return /* @__PURE__ */ jsx(Dialog, {
		open,
		onOpenChange,
		children: /* @__PURE__ */ jsxs(DialogContent, { children: [/* @__PURE__ */ jsxs(DialogHeader, { children: [/* @__PURE__ */ jsx(DialogTitle, { children: "Withdraw funds" }), /* @__PURE__ */ jsxs(DialogDescription, { children: ["Available balance: ", /* @__PURE__ */ jsxs("span", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Button, {
					...
					children: [submitting ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : null, " Request withdraw"]
				}),
				/* @__PURE__ */ jsx("p", {
					className: "text-center text-xs text-muted-foreground",
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Trophy, { className: "size-4" }), "Sportsbook"]
						}), /* @__PURE__ */ jsxs("button", {
							type: "button",
							...
							children: [/* @__PURE__ */ jsx(Dices, { className: "size-4" }), "Live Casino"]
						})]
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "grid gap-6 lg:grid-cols-[1fr_340px]",
						children: [/* @__PURE__ */ jsx("div", { children: activeTab === "sports" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("h2", {
							className: "mb-3 text-sm font-bold uppercase tracking-wide text-muted-foreground",
							children: "Upcoming matches"
						}), /* @__PURE__ */ jsx(MatchList, {
							matches: matchData,
							...
							onPick: pick
						})] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("h2", {
							className: "mb-3 text-sm font-bold uppercase tracking-wide text-muted-foreground",
							children: "Live casino games"
						}), /* @__PURE__ */ jsx(CasinoGrid, {
							signedIn,
							onPlay: handleCasinoPlay
						})] }) }), activeTab === "sports" ? /* @__PURE__ */ jsx("aside", {
							className: "lg:sticky lg:top-20 lg:h-fit",
							children: /* @__PURE__ */ jsx(BetSlip, {
								selections,
								stake,
